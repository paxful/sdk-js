...
const BASE_PATH = "https://api.paxful.com/paxful/v1".replace(/\/+$/, "");
        ...
        list(countryIso?: string, options: any = {}): FetchArgs {
            ...
            if (configuration && configuration.accessToken) {
				const localVarAccessTokenValue = typeof configuration.accessToken === 'function'
					? configuration.accessToken("OAuth2", ["email", "profile", "paxful:user:me", "paxful:bank:list", "paxful:offer:all", "paxful:offer:get", "paxful:trade:get", "paxful:user:info", "paxful:offer:bulk", "paxful:offer:list", "paxful:trade:fund", "paxful:trade:list", "paxful:trade:paid", "paxful:user:block", "paxful:user:touch", "paxful:user:trust", "paxful:user:types", "paxful:crypto:list", "paxful:offer:price", "paxful:trade:start", "paxful:currency:btc", "paxful:offer:create", "paxful:offer:delete", "paxful:offer:prices", "paxful:offer:update", "paxful:trade:cancel", "paxful:trade:reopen", "paxful:user:unblock", "paxful:user:untrust", "paxful:currency:list", "paxful:feedback:give", "paxful:feedback:list", "paxful:offer:turn-on", "paxful:trade:dispute", "paxful:trade:release", "paxful:currency:rates", "paxful:feedback:reply", "paxful:offer-tag:list", "paxful:offer:activate", "paxful:offer:turn-off", "paxful:trade-chat:get", "paxful:user:affiliate", "paxful:wallet:balance", "paxful:wallet:convert", "paxful:trade-chat:post", "paxful:trade:add-proof", "paxful:trade:completed", "paxful:trade:locations", "paxful:bank-account:get", "paxful:offer:deactivate", "paxful:trade-chat:image", "paxful:transactions:all", "paxful:bank-account:list", "paxful:trade-chat:latest", "paxful:user:blocked-list", "paxful:kiosk:transactions", "paxful:notifications:last", "paxful:notifications:list", "paxful:offer:update-price", "paxful:payment-method:fee", "paxful:wallet:new-address", "paxful:bank-account:create", "paxful:bank-account:delete", "paxful:bank-account:update", "paxful:payment-method:list", "paxful:notifications:unread", "paxful:trade-chat:image:add", "paxful:trade:dispute-reasons", "paxful:wallet:list-addresses", "paxful:notifications:mark-read", "paxful:trade-chat:image:upload", "paxful:wallet:conversion-quotes", "paxful:payment-method-group:list", "paxful:notifications:unread-count"])
...
export const BankApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        list(countryIso?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse2001> {
            const localVarFetchArgs = BankApiFetchParamCreator(configuration).list(countryIso, options);
...
export const BankApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        list(countryIso?: string, options?: any) {
            return BankApiFp(configuration).list(countryIso, options)(fetch, basePath);
        },
    };
};
...
export class BankApi extends BaseAPI {
     ...
     * @memberof BankApi
     */
    public list(countryIso?: string, options?: any) {
        return BankApiFp(this.configuration).list(countryIso, options)(this.fetch, this.basePath);
    }
 ...
 * @export
 */
export const BankAccountApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Create bank account.
        ...
        create(iban?: string, ifsc?: string, clabe?: string, bankName?: string, bankUuid?: string, swiftCode?: string, countryIso?: string, holderName?: string, isPersonal?: boolean, accountNumber?: string, routingNumber?: string, additionalInfo?: string, fiatCurrencyCode?: string, internationalDetails?: Array<InternationalDetailsObject>, options: any = {}): FetchArgs {
            const localVarPath = `/bank-account/create`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        delete(bankAccountUuid?: string, options: any = {}): FetchArgs {
            const localVarPath = `/bank-account/delete`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        get(bankAccountUuid?: string, options: any = {}): FetchArgs {
            const localVarPath = `/bank-account/get`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        list(options: any = {}): FetchArgs {
            const localVarPath = `/bank-account/list`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        update(options: any = {}): FetchArgs {
            const localVarPath = `/bank-account/update`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
export const BankAccountApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        create(iban?: string, ifsc?: string, clabe?: string, bankName?: string, bankUuid?: string, swiftCode?: string, countryIso?: string, holderName?: string, isPersonal?: boolean, accountNumber?: string, routingNumber?: string, additionalInfo?: string, fiatCurrencyCode?: string, internationalDetails?: Array<InternationalDetailsObject>, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20034> {
            const localVarFetchArgs = BankAccountApiFetchParamCreator(configuration).create(iban, ifsc, clabe, bankName, bankUuid, swiftCode, countryIso, holderName, isPersonal, accountNumber, routingNumber, additionalInfo, fiatCurrencyCode, internationalDetails, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        delete(bankAccountUuid?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ModelObject> {
            const localVarFetchArgs = BankAccountApiFetchParamCreator(configuration).delete(bankAccountUuid, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        get(bankAccountUuid?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20025> {
            const localVarFetchArgs = BankAccountApiFetchParamCreator(configuration).get(bankAccountUuid, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        list(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20027> {
            const localVarFetchArgs = BankAccountApiFetchParamCreator(configuration).list(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        update(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20034> {
            const localVarFetchArgs = BankAccountApiFetchParamCreator(configuration).update(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const BankAccountApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * Create bank account.
         * @summary bank-account/create
         ...
         * @throws {RequiredError}
         */
        create(iban?: string, ifsc?: string, clabe?: string, bankName?: string, bankUuid?: string, swiftCode?: string, countryIso?: string, holderName?: string, isPersonal?: boolean, accountNumber?: string, routingNumber?: string, additionalInfo?: string, fiatCurrencyCode?: string, internationalDetails?: Array<InternationalDetailsObject>, options?: any) {
            return BankAccountApiFp(configuration).create(iban, ifsc, clabe, bankName, bankUuid, swiftCode, countryIso, holderName, isPersonal, accountNumber, routingNumber, additionalInfo, fiatCurrencyCode, internationalDetails, options)(fetch, basePath);
        },
        /**
         * Delete bank account.
         * @summary bank-account/delete
         ...
         * @throws {RequiredError}
         */
        delete(bankAccountUuid?: string, options?: any) {
            return BankAccountApiFp(configuration).delete(bankAccountUuid, options)(fetch, basePath);
        },
        /**
         * Show bank account.
         * @summary bank-account/get
         ...
         * @throws {RequiredError}
         */
        get(bankAccountUuid?: string, options?: any) {
            return BankAccountApiFp(configuration).get(bankAccountUuid, options)(fetch, basePath);
        },
        /**
         * Fetch all available bank accounts.
         * @summary bank-account/list
         ...
         */
        list(options?: any) {
            return BankAccountApiFp(configuration).list(options)(fetch, basePath);
        },
        /**
         * Update bank account.
         * @summary bank-account/update
         ...
         */
        update(options?: any) {
            return BankAccountApiFp(configuration).update(options)(fetch, basePath);
        },
    };
};
...
export class BankAccountApi extends BaseAPI {
     ...
     */
    public create(iban?: string, ifsc?: string, clabe?: string, bankName?: string, bankUuid?: string, swiftCode?: string, countryIso?: string, holderName?: string, isPersonal?: boolean, accountNumber?: string, routingNumber?: string, additionalInfo?: string, fiatCurrencyCode?: string, internationalDetails?: Array<InternationalDetailsObject>, options?: any) {
        return BankAccountApiFp(this.configuration).create(iban, ifsc, clabe, bankName, bankUuid, swiftCode, countryIso, holderName, isPersonal, accountNumber, routingNumber, additionalInfo, fiatCurrencyCode, internationalDetails, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof BankAccountApi
     */
    public delete(bankAccountUuid?: string, options?: any) {
        return BankAccountApiFp(this.configuration).delete(bankAccountUuid, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof BankAccountApi
     */
    public get(bankAccountUuid?: string, options?: any) {
        return BankAccountApiFp(this.configuration).get(bankAccountUuid, options)(this.fetch, this.basePath);
    }
    ...
    public list(options?: any) {
        return BankAccountApiFp(this.configuration).list(options)(this.fetch, this.basePath);
    }
    ...
    public update(options?: any) {
        return BankAccountApiFp(this.configuration).update(options)(this.fetch, this.basePath);
    }
...
export const CurrencyApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        cryptoList(options: any = {}): FetchArgs {
            const localVarPath = `/crypto/list`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        btc(response?: string, options: any = {}): FetchArgs {
            const localVarPath = `/currency/btc`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        list(locale?: string, options: any = {}): FetchArgs {
            const localVarPath = `/currency/list`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        listAuth(locale?: string, options: any = {}): FetchArgs {
            const localVarPath = `/currency/list-auth`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
export const CurrencyApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        cryptoList(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse2009> {
            const localVarFetchArgs = CurrencyApiFetchParamCreator(configuration).cryptoList(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        btc(response?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<CurrencyBtcResponse> {
            const localVarFetchArgs = CurrencyApiFetchParamCreator(configuration).btc(response, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        list(locale?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20014> {
            const localVarFetchArgs = CurrencyApiFetchParamCreator(configuration).list(locale, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        listAuth(locale?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20014> {
            const localVarFetchArgs = CurrencyApiFetchParamCreator(configuration).listAuth(locale, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        rates(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<CurrencyRatesResponse> {
            const localVarFetchArgs = CurrencyApiFetchParamCreator(configuration).rates(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const CurrencyApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        cryptoList(options?: any) {
            return CurrencyApiFp(configuration).cryptoList(options)(fetch, basePath);
        },
        /**
         * Return bitcoin price in US Dollars. The given price is used as indicative price of bitcoin on      the marketplace. Bitcoin price is being updated every 3 minutes. Authentication is optional.
         * @summary currency/btc
         ...
         * @throws {RequiredError}
         */
        btc(response?: string, options?: any) {
            return CurrencyApiFp(configuration).btc(response, options)(fetch, basePath);
        },
        /**
         * Fetch all marketplace supported fiat currencies and their corresponding rates in crypto and USD.      Authentication is optional.
         * @summary currency/list
         ...
         * @throws {RequiredError}
         */
        list(locale?: string, options?: any) {
            return CurrencyApiFp(configuration).list(locale, options)(fetch, basePath);
        },
        /**
         * Fetch all marketplace supported fiat currencies and their corresponding rates in crypto and USD.     Authentication is required.
         * @summary currency/list-auth
         ...
         * @throws {RequiredError}
         */
        listAuth(locale?: string, options?: any) {
            return CurrencyApiFp(configuration).listAuth(locale, options)(fetch, basePath);
        },
        /**
         * Fetch all marketplace supported fiat currencies and their rates in USD and BTC.      Authentication is optional. Deprecated, use currency/list instead.
         * @summary currency/rates
         ...
         */
        rates(options?: any) {
            return CurrencyApiFp(configuration).rates(options)(fetch, basePath);
        },
    };
};
...
export class CurrencyApi extends BaseAPI {
     ...
     */
    public cryptoList(options?: any) {
        return CurrencyApiFp(this.configuration).cryptoList(options)(this.fetch, this.basePath);
    }
     ...
     * @memberof CurrencyApi
     */
    public btc(response?: string, options?: any) {
        return CurrencyApiFp(this.configuration).btc(response, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof CurrencyApi
     */
    public list(locale?: string, options?: any) {
        return CurrencyApiFp(this.configuration).list(locale, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof CurrencyApi
     */
    public listAuth(locale?: string, options?: any) {
        return CurrencyApiFp(this.configuration).listAuth(locale, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof CurrencyApi
     */
    public rates(options?: any) {
        return CurrencyApiFp(this.configuration).rates(options)(this.fetch, this.basePath);
    }
 ...
 * @export
 */
export const FeedbackApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
        ...
        give(rating: number, message: string, tradeHash: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/feedback/give`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
Either this filter or &#x27;username&#x27; has to be used, if both are provided then an error will be returned.
        ...
        reply(message: string, tradeHash: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/feedback/reply`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
export const FeedbackApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        give(rating: number, message: string, tradeHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessTrueResponse> {
            const localVarFetchArgs = FeedbackApiFetchParamCreator(configuration).give(rating, message, tradeHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
Either this filter or &#x27;username&#x27; has to be used, if both are provided then an error will be returned.
         ...
         * @throws {RequiredError}
         */
        list(page?: number, role?: string, rating?: number, username?: string, offerHash?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20015> {
            const localVarFetchArgs = FeedbackApiFetchParamCreator(configuration).list(page, role, rating, username, offerHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        reply(message: string, tradeHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessResponse> {
            const localVarFetchArgs = FeedbackApiFetchParamCreator(configuration).reply(message, tradeHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const FeedbackApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * Give a feedback for a trade.             NB! Message should be encoded as required per RFC 3986 (i.e. spaces should look like %20).
         * @summary feedback/give
         ...
         * @throws {RequiredError}
         */
        give(rating: number, message: string, tradeHash: string, options?: any) {
            return FeedbackApiFp(configuration).give(rating, message, tradeHash, options)(fetch, basePath);
        },
        /**
         * Fetch all feedback either for a user or an offer. Latest feedback is returned first.
         * @summary feedback/list
...
Either this filter or &#x27;username&#x27; has to be used, if both are provided then an error will be returned.
         ...
         * @throws {RequiredError}
         */
        list(page?: number, role?: string, rating?: number, username?: string, offerHash?: string, options?: any) {
            return FeedbackApiFp(configuration).list(page, role, rating, username, offerHash, options)(fetch, basePath);
        },
        /**
         * Reply to feedback.
         * @summary feedback/reply
         ...
         * @throws {RequiredError}
         */
        reply(message: string, tradeHash: string, options?: any) {
            return FeedbackApiFp(configuration).reply(message, tradeHash, options)(fetch, basePath);
        },
    };
};
...
export class FeedbackApi extends BaseAPI {
     ...
     */
    public give(rating: number, message: string, tradeHash: string, options?: any) {
        return FeedbackApiFp(this.configuration).give(rating, message, tradeHash, options)(this.fetch, this.basePath);
    }
...
Either this filter or &#x27;username&#x27; has to be used, if both are provided then an error will be returned.
     ...
     * @memberof FeedbackApi
     */
    public list(page?: number, role?: string, rating?: number, username?: string, offerHash?: string, options?: any) {
        return FeedbackApiFp(this.configuration).list(page, role, rating, username, offerHash, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof FeedbackApi
     */
    public reply(message: string, tradeHash: string, options?: any) {
        return FeedbackApiFp(this.configuration).reply(message, tradeHash, options)(this.fetch, this.basePath);
    }
 ...
 * @export
 */
export const KioskApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
        ...
        transactions(page?: number, options: any = {}): FetchArgs {
            const localVarPath = `/kiosk/transactions`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
export const KioskApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        transactions(page?: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20030> {
            const localVarFetchArgs = KioskApiFetchParamCreator(configuration).transactions(page, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const KioskApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * Fetch a list of your Kiosk affiliate transactions. Two types of transactions returned:     commissions you have earned when people trade through your Kiosk,     transfers between affiliate wallet and main wallet.
         * @summary kiosk/transactions
         ...
         * @throws {RequiredError}
         */
        transactions(page?: number, options?: any) {
            return KioskApiFp(configuration).transactions(page, options)(fetch, basePath);
        },
    };
};
...
export class KioskApi extends BaseAPI {
     ...
     * @memberof KioskApi
     */
    public transactions(page?: number, options?: any) {
        return KioskApiFp(this.configuration).transactions(page, options)(this.fetch, this.basePath);
    }
...
export const NotificationsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        list(page?: number, isRead?: boolean, options: any = {}): FetchArgs {
            const localVarPath = `/notifications/list`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
export const NotificationsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        list(page?: number, isRead?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20031> {
            const localVarFetchArgs = NotificationsApiFetchParamCreator(configuration).list(page, isRead, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        markRead(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessResponse> {
            const localVarFetchArgs = NotificationsApiFetchParamCreator(configuration).markRead(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        unreadCount(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20038> {
            const localVarFetchArgs = NotificationsApiFetchParamCreator(configuration).unreadCount(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const NotificationsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        list(page?: number, isRead?: boolean, options?: any) {
            return NotificationsApiFp(configuration).list(page, isRead, options)(fetch, basePath);
        },
        /**
         * Mark all unread notifications as read.
         * @summary notifications/mark-read
         ...
         * @throws {RequiredError}
         */
        markRead(options?: any) {
            return NotificationsApiFp(configuration).markRead(options)(fetch, basePath);
        },
        /**
         * Fetch the number of unread notifications.
         * @summary notifications/unread-count
         ...
         * @throws {RequiredError}
         */
        unreadCount(options?: any) {
            return NotificationsApiFp(configuration).unreadCount(options)(fetch, basePath);
        },
    };
};
...
export class NotificationsApi extends BaseAPI {
     ...
     */
    public list(page?: number, isRead?: boolean, options?: any) {
        return NotificationsApiFp(this.configuration).list(page, isRead, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof NotificationsApi
     */
    public markRead(options?: any) {
        return NotificationsApiFp(this.configuration).markRead(options)(this.fetch, this.basePath);
    }
     ...
     * @memberof NotificationsApi
     */
    public unreadCount(options?: any) {
        return NotificationsApiFp(this.configuration).unreadCount(options)(this.fetch, this.basePath);
    }
...
export const OfferApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        activate(offerHash: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/offer/activate`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
For better experience use locations ids of countries and cities.
        ...
        create(tags: string, margin: number, currency: string, flowType: string, rangeMax: number, rangeMin: number, fixedPrice: number, locationId: number, offerTerms: string, bankAccounts: string, tradeDetails: string, isFixedPrice: boolean, paymentMethod: string, paymentWindow: number, cryptoCurrency: string, paymentCountry: string, offerTypeField: string, predefinedAmount: string, paymentMethodGroup: string, paymentMethodLabel: string, bankReferenceMessage: OfferUpdateRequestBodyBankReferenceMessage, showOnlyTrustedUser: boolean, countryLimitationList: string, countryLimitationType: string, requireMinPastTrades: number, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/offer/create`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        deactivate(offerHash: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/offer/deactivate`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        price(offerHash: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/offer/price`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        prices(paymentMethod: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/offer/prices`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        turnOff(options: any = {}): FetchArgs {
            const localVarPath = `/offer/turn-off`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        turnOn(options: any = {}): FetchArgs {
            const localVarPath = `/offer/turn-on`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
For better experience use locations ids of countries and cities.
        ...
        update(tags: string, margin: number, currency: string, flowType: string, offerCap: OfferUpdateRequestBodyOfferCap, rangeMax: number, rangeMin: number, dutyHours: Array<OfferDutyHours>, offerHash: string, fixedPrice: number, locationId: number, offerTerms: string, bankAccounts: string, tradeDetails: string, paymentMethod: string, paymentWindow: number, paymentCountry: string, predefinedAmount: string, paymentMethodGroup: string, paymentMethodLabel: string, bankReferenceMessage: OfferUpdateRequestBodyBankReferenceMessage, showOnlyTrustedUser: boolean, countryLimitationList: string, countryLimitationType: string, requireMinPastTrades: boolean, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/offer/update`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        updatePrice(margin: number, offerHash: string, fixedPrice: number, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/offer/update-price`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
export const OfferApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        activate(offerHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessTrueResponse> {
            const localVarFetchArgs = OfferApiFetchParamCreator(configuration).activate(offerHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
For authenticated user by default automatically detected country will be used. For non-authenticated user &#x27;US&#x27; will be used. This filter corresponds to &#x27;Offer location&#x27; filter available on marketplace.
         ...
         * @throws {RequiredError}
         */
        all(type: string, group: string, limit: number, offset: number, fiatMin: number, geonameId: number, marginMax: number, marginMin: number, offerType: string, userTypes: string, locationId: number, userCountry: string, currencyCode: string, paymentMethod: string, fiatAmountMax: number, fiatAmountMin: number, cryptoCurrencyCode: string, fiatFixedPriceMax: number, fiatFixedPriceMin: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse2002> {
            const localVarFetchArgs = OfferApiFetchParamCreator(configuration).all(type, group, limit, offset, fiatMin, geonameId, marginMax, marginMin, offerType, userTypes, locationId, userCountry, currencyCode, paymentMethod, fiatAmountMax, fiatAmountMin, cryptoCurrencyCode, fiatFixedPriceMax, fiatFixedPriceMin, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
For better experience use locations ids of countries and cities.
         ...
         * @throws {RequiredError}
         */
        create(tags: string, margin: number, currency: string, flowType: string, rangeMax: number, rangeMin: number, fixedPrice: number, locationId: number, offerTerms: string, bankAccounts: string, tradeDetails: string, isFixedPrice: boolean, paymentMethod: string, paymentWindow: number, cryptoCurrency: string, paymentCountry: string, offerTypeField: string, predefinedAmount: string, paymentMethodGroup: string, paymentMethodLabel: string, bankReferenceMessage: OfferUpdateRequestBodyBankReferenceMessage, showOnlyTrustedUser: boolean, countryLimitationList: string, countryLimitationType: string, requireMinPastTrades: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20012> {
            const localVarFetchArgs = OfferApiFetchParamCreator(configuration).create(tags, margin, currency, flowType, rangeMax, rangeMin, fixedPrice, locationId, offerTerms, bankAccounts, tradeDetails, isFixedPrice, paymentMethod, paymentWindow, cryptoCurrency, paymentCountry, offerTypeField, predefinedAmount, paymentMethodGroup, paymentMethodLabel, bankReferenceMessage, showOnlyTrustedUser, countryLimitationList, countryLimitationType, requireMinPastTrades, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        deactivate(offerHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessTrueResponse> {
            const localVarFetchArgs = OfferApiFetchParamCreator(configuration).deactivate(offerHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        delete(offerHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessTrueResponse> {
            const localVarFetchArgs = OfferApiFetchParamCreator(configuration).delete(offerHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        get(offerHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse2003> {
            const localVarFetchArgs = OfferApiFetchParamCreator(configuration).get(offerHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        list(active: boolean, offerType: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse2006> {
            const localVarFetchArgs = OfferApiFetchParamCreator(configuration).list(active, offerType, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        price(offerHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20010> {
            const localVarFetchArgs = OfferApiFetchParamCreator(configuration).price(offerHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        prices(paymentMethod: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20013> {
            const localVarFetchArgs = OfferApiFetchParamCreator(configuration).prices(paymentMethod, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        turnOff(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20016> {
            const localVarFetchArgs = OfferApiFetchParamCreator(configuration).turnOff(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        turnOn(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20016> {
            const localVarFetchArgs = OfferApiFetchParamCreator(configuration).turnOn(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
For better experience use locations ids of countries and cities.
         ...
         * @throws {RequiredError}
         */
        update(tags: string, margin: number, currency: string, flowType: string, offerCap: OfferUpdateRequestBodyOfferCap, rangeMax: number, rangeMin: number, dutyHours: Array<OfferDutyHours>, offerHash: string, fixedPrice: number, locationId: number, offerTerms: string, bankAccounts: string, tradeDetails: string, paymentMethod: string, paymentWindow: number, paymentCountry: string, predefinedAmount: string, paymentMethodGroup: string, paymentMethodLabel: string, bankReferenceMessage: OfferUpdateRequestBodyBankReferenceMessage, showOnlyTrustedUser: boolean, countryLimitationList: string, countryLimitationType: string, requireMinPastTrades: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessTrueResponse> {
            const localVarFetchArgs = OfferApiFetchParamCreator(configuration).update(tags, margin, currency, flowType, offerCap, rangeMax, rangeMin, dutyHours, offerHash, fixedPrice, locationId, offerTerms, bankAccounts, tradeDetails, paymentMethod, paymentWindow, paymentCountry, predefinedAmount, paymentMethodGroup, paymentMethodLabel, bankReferenceMessage, showOnlyTrustedUser, countryLimitationList, countryLimitationType, requireMinPastTrades, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        updatePrice(margin: number, offerHash: string, fixedPrice: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessTrueResponse> {
            const localVarFetchArgs = OfferApiFetchParamCreator(configuration).updatePrice(margin, offerHash, fixedPrice, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const OfferApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        activate(offerHash: string, options?: any) {
            return OfferApiFp(configuration).activate(offerHash, options)(fetch, basePath);
        },
        /**
         * Fetch offers. Authentication is optional         (replaces deprecated method of /buy-bitcoin?format=json, results are cached for 1 minute).
         * @summary offer/all
...
For authenticated user by default automatically detected country will be used. For non-authenticated user &#x27;US&#x27; will be used. This filter corresponds to &#x27;Offer location&#x27; filter available on marketplace.
         ...
         * @throws {RequiredError}
         */
        all(type: string, group: string, limit: number, offset: number, fiatMin: number, geonameId: number, marginMax: number, marginMin: number, offerType: string, userTypes: string, locationId: number, userCountry: string, currencyCode: string, paymentMethod: string, fiatAmountMax: number, fiatAmountMin: number, cryptoCurrencyCode: string, fiatFixedPriceMax: number, fiatFixedPriceMin: number, options?: any) {
            return OfferApiFp(configuration).all(type, group, limit, offset, fiatMin, geonameId, marginMax, marginMin, offerType, userTypes, locationId, userCountry, currencyCode, paymentMethod, fiatAmountMax, fiatAmountMin, cryptoCurrencyCode, fiatFixedPriceMax, fiatFixedPriceMin, options)(fetch, basePath);
        },
        /**
         * Create an offer.
         * @summary offer/create
...
For better experience use locations ids of countries and cities.
         ...
         * @throws {RequiredError}
         */
        create(tags: string, margin: number, currency: string, flowType: string, rangeMax: number, rangeMin: number, fixedPrice: number, locationId: number, offerTerms: string, bankAccounts: string, tradeDetails: string, isFixedPrice: boolean, paymentMethod: string, paymentWindow: number, cryptoCurrency: string, paymentCountry: string, offerTypeField: string, predefinedAmount: string, paymentMethodGroup: string, paymentMethodLabel: string, bankReferenceMessage: OfferUpdateRequestBodyBankReferenceMessage, showOnlyTrustedUser: boolean, countryLimitationList: string, countryLimitationType: string, requireMinPastTrades: number, options?: any) {
            return OfferApiFp(configuration).create(tags, margin, currency, flowType, rangeMax, rangeMin, fixedPrice, locationId, offerTerms, bankAccounts, tradeDetails, isFixedPrice, paymentMethod, paymentWindow, cryptoCurrency, paymentCountry, offerTypeField, predefinedAmount, paymentMethodGroup, paymentMethodLabel, bankReferenceMessage, showOnlyTrustedUser, countryLimitationList, countryLimitationType, requireMinPastTrades, options)(fetch, basePath);
        },
        /**
         * Deactivate an offer.
         * @summary offer/deactivate
         ...
         * @throws {RequiredError}
         */
        deactivate(offerHash: string, options?: any) {
            return OfferApiFp(configuration).deactivate(offerHash, options)(fetch, basePath);
        },
        /**
         * Delete an offer.
         * @summary offer/delete
         ...
         * @throws {RequiredError}
         */
        delete(offerHash: string, options?: any) {
            return OfferApiFp(configuration).delete(offerHash, options)(fetch, basePath);
        },
        /**
         * Fetch information for an offer.
         * @summary offer/get
         ...
         * @throws {RequiredError}
         */
        get(offerHash: string, options?: any) {
            return OfferApiFp(configuration).get(offerHash, options)(fetch, basePath);
        },
        /**
         * Return all your offers.
         * @summary offer/list
         ...
         * @throws {RequiredError}
         */
        list(active: boolean, offerType: string, options?: any) {
            return OfferApiFp(configuration).list(active, offerType, options)(fetch, basePath);
        },
        /**
         * Return a price for an offer         (if offer happens to be in fiat currency other than USD, then it will be recalculated to it).
         * @summary offer/price
         ...
         * @throws {RequiredError}
         */
        price(offerHash: string, options?: any) {
            return OfferApiFp(configuration).price(offerHash, options)(fetch, basePath);
        },
        /**
         * Return all prices for offers for a given payment method.
         * @summary offer/prices
         ...
         * @throws {RequiredError}
         */
        prices(paymentMethod: string, options?: any) {
            return OfferApiFp(configuration).prices(paymentMethod, options)(fetch, basePath);
        },
        /**
         * Turn off all your offers.
         * @summary offer/turn-off
         ...
         */
        turnOff(options?: any) {
            return OfferApiFp(configuration).turnOff(options)(fetch, basePath);
        },
        /**
         * Turn on all your offers.
         * @summary offer/turn-on
         ...
         */
        turnOn(options?: any) {
            return OfferApiFp(configuration).turnOn(options)(fetch, basePath);
        },
        /**
         * Update an offer.
         * @summary offer/update
...
For better experience use locations ids of countries and cities.
         ...
         * @throws {RequiredError}
         */
        update(tags: string, margin: number, currency: string, flowType: string, offerCap: OfferUpdateRequestBodyOfferCap, rangeMax: number, rangeMin: number, dutyHours: Array<OfferDutyHours>, offerHash: string, fixedPrice: number, locationId: number, offerTerms: string, bankAccounts: string, tradeDetails: string, paymentMethod: string, paymentWindow: number, paymentCountry: string, predefinedAmount: string, paymentMethodGroup: string, paymentMethodLabel: string, bankReferenceMessage: OfferUpdateRequestBodyBankReferenceMessage, showOnlyTrustedUser: boolean, countryLimitationList: string, countryLimitationType: string, requireMinPastTrades: boolean, options?: any) {
            return OfferApiFp(configuration).update(tags, margin, currency, flowType, offerCap, rangeMax, rangeMin, dutyHours, offerHash, fixedPrice, locationId, offerTerms, bankAccounts, tradeDetails, paymentMethod, paymentWindow, paymentCountry, predefinedAmount, paymentMethodGroup, paymentMethodLabel, bankReferenceMessage, showOnlyTrustedUser, countryLimitationList, countryLimitationType, requireMinPastTrades, options)(fetch, basePath);
        },
        /**
         * Updates an offer margin or fixed price value.         Which field to use depends on offer type if it is a fixed price or uses a margin.
         ...
         * @throws {RequiredError}
         */
        updatePrice(margin: number, offerHash: string, fixedPrice: number, options?: any) {
            return OfferApiFp(configuration).updatePrice(margin, offerHash, fixedPrice, options)(fetch, basePath);
        },
    };
};
...
export class OfferApi extends BaseAPI {
     ...
     * @memberof OfferApi
     */
    public activate(offerHash: string, options?: any) {
        return OfferApiFp(this.configuration).activate(offerHash, options)(this.fetch, this.basePath);
    }
...
For authenticated user by default automatically detected country will be used. For non-authenticated user &#x27;US&#x27; will be used. This filter corresponds to &#x27;Offer location&#x27; filter available on marketplace.
     ...
     * @memberof OfferApi
     */
    public all(type: string, group: string, limit: number, offset: number, fiatMin: number, geonameId: number, marginMax: number, marginMin: number, offerType: string, userTypes: string, locationId: number, userCountry: string, currencyCode: string, paymentMethod: string, fiatAmountMax: number, fiatAmountMin: number, cryptoCurrencyCode: string, fiatFixedPriceMax: number, fiatFixedPriceMin: number, options?: any) {
        return OfferApiFp(this.configuration).all(type, group, limit, offset, fiatMin, geonameId, marginMax, marginMin, offerType, userTypes, locationId, userCountry, currencyCode, paymentMethod, fiatAmountMax, fiatAmountMin, cryptoCurrencyCode, fiatFixedPriceMax, fiatFixedPriceMin, options)(this.fetch, this.basePath);
    }
...
For better experience use locations ids of countries and cities.
     ...
     * @memberof OfferApi
     */
    public create(tags: string, margin: number, currency: string, flowType: string, rangeMax: number, rangeMin: number, fixedPrice: number, locationId: number, offerTerms: string, bankAccounts: string, tradeDetails: string, isFixedPrice: boolean, paymentMethod: string, paymentWindow: number, cryptoCurrency: string, paymentCountry: string, offerTypeField: string, predefinedAmount: string, paymentMethodGroup: string, paymentMethodLabel: string, bankReferenceMessage: OfferUpdateRequestBodyBankReferenceMessage, showOnlyTrustedUser: boolean, countryLimitationList: string, countryLimitationType: string, requireMinPastTrades: number, options?: any) {
        return OfferApiFp(this.configuration).create(tags, margin, currency, flowType, rangeMax, rangeMin, fixedPrice, locationId, offerTerms, bankAccounts, tradeDetails, isFixedPrice, paymentMethod, paymentWindow, cryptoCurrency, paymentCountry, offerTypeField, predefinedAmount, paymentMethodGroup, paymentMethodLabel, bankReferenceMessage, showOnlyTrustedUser, countryLimitationList, countryLimitationType, requireMinPastTrades, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof OfferApi
     */
    public deactivate(offerHash: string, options?: any) {
        return OfferApiFp(this.configuration).deactivate(offerHash, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof OfferApi
     */
    public delete(offerHash: string, options?: any) {
        return OfferApiFp(this.configuration).delete(offerHash, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof OfferApi
     */
    public get(offerHash: string, options?: any) {
        return OfferApiFp(this.configuration).get(offerHash, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof OfferApi
     */
    public list(active: boolean, offerType: string, options?: any) {
        return OfferApiFp(this.configuration).list(active, offerType, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof OfferApi
     */
    public price(offerHash: string, options?: any) {
        return OfferApiFp(this.configuration).price(offerHash, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof OfferApi
     */
    public prices(paymentMethod: string, options?: any) {
        return OfferApiFp(this.configuration).prices(paymentMethod, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof OfferApi
     */
    public turnOff(options?: any) {
        return OfferApiFp(this.configuration).turnOff(options)(this.fetch, this.basePath);
    }
     ...
     * @memberof OfferApi
     */
    public turnOn(options?: any) {
        return OfferApiFp(this.configuration).turnOn(options)(this.fetch, this.basePath);
    }
...
For better experience use locations ids of countries and cities.
     ...
     */
    public update(tags: string, margin: number, currency: string, flowType: string, offerCap: OfferUpdateRequestBodyOfferCap, rangeMax: number, rangeMin: number, dutyHours: Array<OfferDutyHours>, offerHash: string, fixedPrice: number, locationId: number, offerTerms: string, bankAccounts: string, tradeDetails: string, paymentMethod: string, paymentWindow: number, paymentCountry: string, predefinedAmount: string, paymentMethodGroup: string, paymentMethodLabel: string, bankReferenceMessage: OfferUpdateRequestBodyBankReferenceMessage, showOnlyTrustedUser: boolean, countryLimitationList: string, countryLimitationType: string, requireMinPastTrades: boolean, options?: any) {
        return OfferApiFp(this.configuration).update(tags, margin, currency, flowType, offerCap, rangeMax, rangeMin, dutyHours, offerHash, fixedPrice, locationId, offerTerms, bankAccounts, tradeDetails, paymentMethod, paymentWindow, paymentCountry, predefinedAmount, paymentMethodGroup, paymentMethodLabel, bankReferenceMessage, showOnlyTrustedUser, countryLimitationList, countryLimitationType, requireMinPastTrades, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof OfferApi
     */
    public updatePrice(margin: number, offerHash: string, fixedPrice: number, options?: any) {
        return OfferApiFp(this.configuration).updatePrice(margin, offerHash, fixedPrice, options)(this.fetch, this.basePath);
    }
 ...
 * @export
 */
export const OfferTagApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        list(options: any = {}): FetchArgs {
            const localVarPath = `/offer-tag/list`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
/**
 * OfferTagApi - functional programming interface
 * @export
 */
export const OfferTagApiFp = function(configuration?: Configuration) {
    return {
        /**
         * Fetch all available tags that can be associated with offers.
         * @summary offer-tag/list
         ...
         * @throws {RequiredError}
         */
        list(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20017> {
            const localVarFetchArgs = OfferTagApiFetchParamCreator(configuration).list(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
/**
 * OfferTagApi - factory interface
 * @export
 */
export const OfferTagApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * Fetch all available tags that can be associated with offers.
         * @summary offer-tag/list
         ...
         */
        list(options?: any) {
            return OfferTagApiFp(configuration).list(options)(fetch, basePath);
        },
    };
};

/**
 * OfferTagApi - object-oriented interface
 * @export
 * @class OfferTagApi
 * @extends {BaseAPI}
 */
export class OfferTagApi extends BaseAPI {
     ...
     */
    public list(options?: any) {
        return OfferTagApiFp(this.configuration).list(options)(this.fetch, this.basePath);
    }
...
export const PaymentMethodApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        fee(slug: string, currency: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/payment-method/fee`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        groupList(locale?: string, options: any = {}): FetchArgs {
            const localVarPath = `/payment-method-group/list`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
         ...
         */
        list(options: any = {}): FetchArgs {
            const localVarPath = `/payment-method/list`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
export const PaymentMethodApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        fee(slug: string, currency: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20032> {
            const localVarFetchArgs = PaymentMethodApiFetchParamCreator(configuration).fee(slug, currency, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        groupList(locale?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PaymentMethodGroupResponse> {
            const localVarFetchArgs = PaymentMethodApiFetchParamCreator(configuration).groupList(locale, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        list(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PaymentMethodListResponse> {
            const localVarFetchArgs = PaymentMethodApiFetchParamCreator(configuration).list(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const PaymentMethodApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        fee(slug: string, currency: string, options?: any) {
            return PaymentMethodApiFp(configuration).fee(slug, currency, options)(fetch, basePath);
        },
        /**
         * Fetch a list of available payment method groups. Authentication is optional.
         * @summary payment-method-group/list
         ...
         * @throws {RequiredError}
         */
        groupList(locale?: string, options?: any) {
            return PaymentMethodApiFp(configuration).groupList(locale, options)(fetch, basePath);
        },
        /**
         * Fetch a list of available payment methods. Authentication is optional.
         * @summary payment-method/list
         ...
         */
        list(options?: any) {
            return PaymentMethodApiFp(configuration).list(options)(fetch, basePath);
        },
    };
};
...
export class PaymentMethodApi extends BaseAPI {
     ...
     */
    public fee(slug: string, currency: string, options?: any) {
        return PaymentMethodApiFp(this.configuration).fee(slug, currency, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof PaymentMethodApi
     */
    public groupList(locale?: string, options?: any) {
        return PaymentMethodApiFp(this.configuration).groupList(locale, options)(this.fetch, this.basePath);
    }
     ...
     */
    public list(options?: any) {
        return PaymentMethodApiFp(this.configuration).list(options)(this.fetch, this.basePath);
    }
 ...
 * @export
 */
export const TradeApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
        ...
        addProof(options: any = {}): FetchArgs {
            const localVarPath = `/trade/add-proof`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        cancel(tradeHash: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/trade/cancel`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        completed(page: number, partner: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/trade/completed`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        dispute(reason: string, tradeHash: string, reasonType: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/trade/dispute`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        disputeReasons(tradeHash: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/trade/dispute-reasons`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        locations(tradeHash: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/trade/locations`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        release(tradeHash: string, xPaxful2fa?: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/trade/release`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        reopen(tradeHash: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/trade/reopen`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        start(fiat: number, satoshi: number, offerHash: string, bankAccounts: Array<RequestBodyTradeStartBankAccounts>, cryptoAmount: number, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/trade/start`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        useBankAccount(options: any = {}): FetchArgs {
            const localVarPath = `/trade/use-bank-account`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
export const TradeApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        addProof(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessTrueResponse> {
            const localVarFetchArgs = TradeApiFetchParamCreator(configuration).addProof(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        cancel(tradeHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessTrueResponse> {
            const localVarFetchArgs = TradeApiFetchParamCreator(configuration).cancel(tradeHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        completed(page: number, partner: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20023> {
            const localVarFetchArgs = TradeApiFetchParamCreator(configuration).completed(page, partner, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        dispute(reason: string, tradeHash: string, reasonType: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessTrueResponse> {
            const localVarFetchArgs = TradeApiFetchParamCreator(configuration).dispute(reason, tradeHash, reasonType, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        disputeReasons(tradeHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20035> {
            const localVarFetchArgs = TradeApiFetchParamCreator(configuration).disputeReasons(tradeHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        fund(tradeHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessTrueResponse> {
            const localVarFetchArgs = TradeApiFetchParamCreator(configuration).fund(tradeHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        get(tradeHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse2004> {
            const localVarFetchArgs = TradeApiFetchParamCreator(configuration).get(tradeHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        list(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse2007> {
            const localVarFetchArgs = TradeApiFetchParamCreator(configuration).list(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        locations(tradeHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20024> {
            const localVarFetchArgs = TradeApiFetchParamCreator(configuration).locations(tradeHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        paid(tradeHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessTrueResponse> {
            const localVarFetchArgs = TradeApiFetchParamCreator(configuration).paid(tradeHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        release(tradeHash: string, xPaxful2fa?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessTrueResponse> {
            const localVarFetchArgs = TradeApiFetchParamCreator(configuration).release(tradeHash, xPaxful2fa, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        reopen(tradeHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessTrueResponse> {
            const localVarFetchArgs = TradeApiFetchParamCreator(configuration).reopen(tradeHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        start(fiat: number, satoshi: number, offerHash: string, bankAccounts: Array<RequestBodyTradeStartBankAccounts>, cryptoAmount: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20011> {
            const localVarFetchArgs = TradeApiFetchParamCreator(configuration).start(fiat, satoshi, offerHash, bankAccounts, cryptoAmount, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        useBankAccount(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessTrueResponse> {
            const localVarFetchArgs = TradeApiFetchParamCreator(configuration).useBankAccount(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const TradeApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * Add proof of payments to trade. Method is to be used only for trades with 'Bank Transfer' payment method.
         * @summary trade/add-proof
         ...
         * @throws {RequiredError}
         */
        addProof(options?: any) {
            return TradeApiFp(configuration).addProof(options)(fetch, basePath);
        },
        /**
         * Cancel a trade.
         * @summary trade/cancel
         ...
         * @throws {RequiredError}
         */
        cancel(tradeHash: string, options?: any) {
            return TradeApiFp(configuration).cancel(tradeHash, options)(fetch, basePath);
        },
        /**
         * Fetch a list of your completed trades, optionally limited by partner username.
         * @summary trade/completed
         ...
         * @throws {RequiredError}
         */
        completed(page: number, partner: string, options?: any) {
            return TradeApiFp(configuration).completed(page, partner, options)(fetch, basePath);
        },
        /**
         * Open a dispute.
         * @summary trade/dispute
         ...
         * @throws {RequiredError}
         */
        dispute(reason: string, tradeHash: string, reasonType: string, options?: any) {
            return TradeApiFp(configuration).dispute(reason, tradeHash, reasonType, options)(fetch, basePath);
        },
        /**
         * Fetch a list of available dispute reasons.
         * @summary trade/dispute-reasons
         ...
         * @throws {RequiredError}
         */
        disputeReasons(tradeHash: string, options?: any) {
            return TradeApiFp(configuration).disputeReasons(tradeHash, options)(fetch, basePath);
        },
        /**
         * Fund a deferred escrow trade.
         * @summary trade/fund
         ...
         * @throws {RequiredError}
         */
        fund(tradeHash: string, options?: any) {
            return TradeApiFp(configuration).fund(tradeHash, options)(fetch, basePath);
        },
        /**
         * Fetch information for an active/completed trade.
         * @summary trade/get
         ...
         * @throws {RequiredError}
         */
        get(tradeHash: string, options?: any) {
            return TradeApiFp(configuration).get(tradeHash, options)(fetch, basePath);
        },
        /**
         * List all your currently active trades.
         * @summary trade/list
         ...
         */
        list(options?: any) {
            return TradeApiFp(configuration).list(options)(fetch, basePath);
        },
        /**
         * Fetch information for seller and buyer locations in a trade.     Restricted: User requesting the information must be a trade partner.
         * @summary trade/locations
         ...
         * @throws {RequiredError}
         */
        locations(tradeHash: string, options?: any) {
            return TradeApiFp(configuration).locations(tradeHash, options)(fetch, basePath);
        },
        /**
         * Mark trade as PAID.
         * @summary trade/paid
         ...
         * @throws {RequiredError}
         */
        paid(tradeHash: string, options?: any) {
            return TradeApiFp(configuration).paid(tradeHash, options)(fetch, basePath);
        },
        /**
         * Release crypto for a trade.
         * @summary trade/release
         ...
         * @throws {RequiredError}
         */
        release(tradeHash: string, xPaxful2fa?: string, options?: any) {
            return TradeApiFp(configuration).release(tradeHash, xPaxful2fa, options)(fetch, basePath);
        },
        /**
         * Reopen trade.
         * @summary trade/reopen
         ...
         * @throws {RequiredError}
         */
        reopen(tradeHash: string, options?: any) {
            return TradeApiFp(configuration).reopen(tradeHash, options)(fetch, basePath);
        },
        /**
         * Start a trade.
         * @summary trade/start
         ...
         * @throws {RequiredError}
         */
        start(fiat: number, satoshi: number, offerHash: string, bankAccounts: Array<RequestBodyTradeStartBankAccounts>, cryptoAmount: number, options?: any) {
            return TradeApiFp(configuration).start(fiat, satoshi, offerHash, bankAccounts, cryptoAmount, options)(fetch, basePath);
        },
        /**
         * Use bank account to the trade. Method is to be used only for trades with 'Bank Transfer' payment method.
         * @summary trade/use-bank-account
         ...
         * @throws {RequiredError}
         */
        useBankAccount(options?: any) {
            return TradeApiFp(configuration).useBankAccount(options)(fetch, basePath);
        },
    };
};
...
export class TradeApi extends BaseAPI {
     ...
     * @memberof TradeApi
     */
    public addProof(options?: any) {
        return TradeApiFp(this.configuration).addProof(options)(this.fetch, this.basePath);
    }
     ...
     * @memberof TradeApi
     */
    public cancel(tradeHash: string, options?: any) {
        return TradeApiFp(this.configuration).cancel(tradeHash, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof TradeApi
     */
    public completed(page: number, partner: string, options?: any) {
        return TradeApiFp(this.configuration).completed(page, partner, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof TradeApi
     */
    public dispute(reason: string, tradeHash: string, reasonType: string, options?: any) {
        return TradeApiFp(this.configuration).dispute(reason, tradeHash, reasonType, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof TradeApi
     */
    public disputeReasons(tradeHash: string, options?: any) {
        return TradeApiFp(this.configuration).disputeReasons(tradeHash, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof TradeApi
     */
    public fund(tradeHash: string, options?: any) {
        return TradeApiFp(this.configuration).fund(tradeHash, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof TradeApi
     */
    public get(tradeHash: string, options?: any) {
        return TradeApiFp(this.configuration).get(tradeHash, options)(this.fetch, this.basePath);
    }
     ...
     */
    public list(options?: any) {
        return TradeApiFp(this.configuration).list(options)(this.fetch, this.basePath);
    }
     ...
     * @memberof TradeApi
     */
    public locations(tradeHash: string, options?: any) {
        return TradeApiFp(this.configuration).locations(tradeHash, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof TradeApi
     */
    public paid(tradeHash: string, options?: any) {
        return TradeApiFp(this.configuration).paid(tradeHash, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof TradeApi
     */
    public release(tradeHash: string, xPaxful2fa?: string, options?: any) {
        return TradeApiFp(this.configuration).release(tradeHash, xPaxful2fa, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof TradeApi
     */
    public reopen(tradeHash: string, options?: any) {
        return TradeApiFp(this.configuration).reopen(tradeHash, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof TradeApi
     */
    public start(fiat: number, satoshi: number, offerHash: string, bankAccounts: Array<RequestBodyTradeStartBankAccounts>, cryptoAmount: number, options?: any) {
        return TradeApiFp(this.configuration).start(fiat, satoshi, offerHash, bankAccounts, cryptoAmount, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof TradeApi
     */
    public useBankAccount(options?: any) {
        return TradeApiFp(this.configuration).useBankAccount(options)(this.fetch, this.basePath);
    }
 ...
 * @export
 */
export const TradeChatApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Fetch messages for a trade.
        ...
        get(tradeHash: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/trade-chat/get`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        image(size: string, imageHash: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/trade-chat/image`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
Please consider using image/upload endpoint instead as it will process uploaded image instantly.
        ...
        imageAdd(file: string, tradeHash: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/trade-chat/image/add`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        imageUpload(file: Blob, tradeHash: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/trade-chat/image/upload`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        latest(tradeHash: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/trade-chat/latest`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        post(message: string, tradeHash: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/trade-chat/post`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
/**
 * TradeChatApi - functional programming interface
 * @export
 */
export const TradeChatApiFp = function(configuration?: Configuration) {
    return {
        /**
         * Fetch messages for a trade.
         * @summary trade-chat/get
         ...
         * @throws {RequiredError}
         */
        get(tradeHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20018> {
            const localVarFetchArgs = TradeChatApiFetchParamCreator(configuration).get(tradeHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        image(size: string, imageHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = TradeChatApiFetchParamCreator(configuration).image(size, imageHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
...
Please consider using image/upload endpoint instead as it will process uploaded image instantly.
         ...
         * @throws {RequiredError}
         */
        imageAdd(file: string, tradeHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20022> {
            const localVarFetchArgs = TradeChatApiFetchParamCreator(configuration).imageAdd(file, tradeHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        imageUpload(file: Blob, tradeHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20022> {
            const localVarFetchArgs = TradeChatApiFetchParamCreator(configuration).imageUpload(file, tradeHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        latest(tradeHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20028> {
            const localVarFetchArgs = TradeChatApiFetchParamCreator(configuration).latest(tradeHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        post(message: string, tradeHash: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20022> {
            const localVarFetchArgs = TradeChatApiFetchParamCreator(configuration).post(message, tradeHash, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
/**
 * TradeChatApi - factory interface
 * @export
 */
export const TradeChatApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * Fetch messages for a trade.
         * @summary trade-chat/get
         ...
         */
        get(tradeHash: string, options?: any) {
            return TradeChatApiFp(configuration).get(tradeHash, options)(fetch, basePath);
        },
        /**
         * Fetch an image attachment from a trade.
         * @summary trade-chat/image
         ...
         * @throws {RequiredError}
         */
        image(size: string, imageHash: string, options?: any) {
            return TradeChatApiFp(configuration).image(size, imageHash, options)(fetch, basePath);
        },
        /**
         * Attach image to a trade chat.
         * @summary trade-chat/image/add
...
Please consider using image/upload endpoint instead as it will process uploaded image instantly.
         ...
         * @throws {RequiredError}
         */
        imageAdd(file: string, tradeHash: string, options?: any) {
            return TradeChatApiFp(configuration).imageAdd(file, tradeHash, options)(fetch, basePath);
        },
        /**
         * Upload image to a trade chat.      This endpoint can be used only with OAuth 2.0 authentiction method.
         * @summary trade-chat/image/upload
         ...
         * @throws {RequiredError}
         */
        imageUpload(file: Blob, tradeHash: string, options?: any) {
            return TradeChatApiFp(configuration).imageUpload(file, tradeHash, options)(fetch, basePath);
        },
        /**
         * Fetch latest messages for all active trades, or for one trade if trade_hash filter is specified.      Latest messages are messages posted in last 10 minutes.
         * @summary trade-chat/latest
         ...
         * @throws {RequiredError}
         */
        latest(tradeHash: string, options?: any) {
            return TradeChatApiFp(configuration).latest(tradeHash, options)(fetch, basePath);
        },
        /**
         * Post message to a trade chat.
         * @summary trade-chat/post
         ...
         * @throws {RequiredError}
         */
        post(message: string, tradeHash: string, options?: any) {
            return TradeChatApiFp(configuration).post(message, tradeHash, options)(fetch, basePath);
        },
    };
};

/**
 * TradeChatApi - object-oriented interface
 * @export
 * @class TradeChatApi
 * @extends {BaseAPI}
 */
export class TradeChatApi extends BaseAPI {
     ...
     */
    public get(tradeHash: string, options?: any) {
        return TradeChatApiFp(this.configuration).get(tradeHash, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof TradeChatApi
     */
    public image(size: string, imageHash: string, options?: any) {
        return TradeChatApiFp(this.configuration).image(size, imageHash, options)(this.fetch, this.basePath);
    }
...
Please consider using image/upload endpoint instead as it will process uploaded image instantly.
     ...
     * @memberof TradeChatApi
     */
    public imageAdd(file: string, tradeHash: string, options?: any) {
        return TradeChatApiFp(this.configuration).imageAdd(file, tradeHash, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof TradeChatApi
     */
    public imageUpload(file: Blob, tradeHash: string, options?: any) {
        return TradeChatApiFp(this.configuration).imageUpload(file, tradeHash, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof TradeChatApi
     */
    public latest(tradeHash: string, options?: any) {
        return TradeChatApiFp(this.configuration).latest(tradeHash, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof TradeChatApi
     */
    public post(message: string, tradeHash: string, options?: any) {
        return TradeChatApiFp(this.configuration).post(message, tradeHash, options)(this.fetch, this.basePath);
    }
...
export const TransactionsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        all(page: number, type: string, limit: number, cryptoCurrencyCode: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/transactions/all`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
export const TransactionsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        all(page: number, type: string, limit: number, cryptoCurrencyCode: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20026> {
            const localVarFetchArgs = TransactionsApiFetchParamCreator(configuration).all(page, type, limit, cryptoCurrencyCode, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const TransactionsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        all(page: number, type: string, limit: number, cryptoCurrencyCode: string, options?: any) {
            return TransactionsApiFp(configuration).all(page, type, limit, cryptoCurrencyCode, options)(fetch, basePath);
        },
    };
};
...
export class TransactionsApi extends BaseAPI {
     ...
     */
    public all(page: number, type: string, limit: number, cryptoCurrencyCode: string, options?: any) {
        return TransactionsApiFp(this.configuration).all(page, type, limit, cryptoCurrencyCode, options)(this.fetch, this.basePath);
    }
...
export const UserApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        affiliate(options: any = {}): FetchArgs {
            const localVarPath = `/user/affiliate`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        blockedList(page?: number, options: any = {}): FetchArgs {
            const localVarPath = `/user/blocked-list`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        unblock(username: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/user/unblock`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        untrust(username: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/user/untrust`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
export const UserApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        currentUser(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse200> {
            const localVarFetchArgs = UserApiFetchParamCreator(configuration).currentUser(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        affiliate(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20019> {
            const localVarFetchArgs = UserApiFetchParamCreator(configuration).affiliate(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        block(username: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessResponse> {
            const localVarFetchArgs = UserApiFetchParamCreator(configuration).block(username, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        blockedList(page?: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20029> {
            const localVarFetchArgs = UserApiFetchParamCreator(configuration).blockedList(page, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        info(username: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse2005> {
            const localVarFetchArgs = UserApiFetchParamCreator(configuration).info(username, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        touch(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessResponse> {
            const localVarFetchArgs = UserApiFetchParamCreator(configuration).touch(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        trust(username: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessResponse> {
            const localVarFetchArgs = UserApiFetchParamCreator(configuration).trust(username, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        types(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse2008> {
            const localVarFetchArgs = UserApiFetchParamCreator(configuration).types(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        unblock(username: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessResponse> {
            const localVarFetchArgs = UserApiFetchParamCreator(configuration).unblock(username, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        untrust(username: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SuccessResponse> {
            const localVarFetchArgs = UserApiFetchParamCreator(configuration).untrust(username, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const UserApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        currentUser(options?: any) {
            return UserApiFp(configuration).currentUser(options)(fetch, basePath);
        },
        /**
         * Get user affiliate info
         * @summary user/affiliate
         ...
         * @throws {RequiredError}
         */
        affiliate(options?: any) {
            return UserApiFp(configuration).affiliate(options)(fetch, basePath);
        },
        /**
         * Add username to blocked list
         * @summary user/block
         ...
         * @throws {RequiredError}
         */
        block(username: string, options?: any) {
            return UserApiFp(configuration).block(username, options)(fetch, basePath);
        },
        /**
         * Fetch a list of your blocked users.
         * @summary user/blocked-list
         ...
         * @throws {RequiredError}
         */
        blockedList(page?: number, options?: any) {
            return UserApiFp(configuration).blockedList(page, options)(fetch, basePath);
        },
        /**
         * Fetch information for a user.
         * @summary user/info
         ...
         * @throws {RequiredError}
         */
        info(username: string, options?: any) {
            return UserApiFp(configuration).info(username, options)(fetch, basePath);
        },
        /**
         * Deprecated. You don't need to use this endpoint directly, last seen time is going to be updated     automatically if you use other API endpoints.     Refresh your last seen time. This endpoint has its own rate limit and is limited to 360 requests per hour     (every 10 second max).
         * @summary user/touch
         ...
         */
        touch(options?: any) {
            return UserApiFp(configuration).touch(options)(fetch, basePath);
        },
        /**
         * Add username to the trusted user list.
         * @summary user/trust
         ...
         * @throws {RequiredError}
         */
        trust(username: string, options?: any) {
            return UserApiFp(configuration).trust(username, options)(fetch, basePath);
        },
        /**
         * Returns a list of available user types. For example - power_trader, expert_trader, etc.      This parameter can be used as “user_type” in offer/all endpoint.
         * @summary user/types
         ...
         */
        types(options?: any) {
            return UserApiFp(configuration).types(options)(fetch, basePath);
        },
        /**
         * Remove user from blocked list.
         * @summary user/unblock
         ...
         * @throws {RequiredError}
         */
        unblock(username: string, options?: any) {
            return UserApiFp(configuration).unblock(username, options)(fetch, basePath);
        },
        /**
         * Remove username from the trusted list.
         * @summary user/untrust
         ...
         * @throws {RequiredError}
         */
        untrust(username: string, options?: any) {
            return UserApiFp(configuration).untrust(username, options)(fetch, basePath);
        },
    };
};
...
export class UserApi extends BaseAPI {
    ...
    public currentUser(options?: any) {
        return UserApiFp(this.configuration).currentUser(options)(this.fetch, this.basePath);
    }
     ...
     * @memberof UserApi
     */
    public affiliate(options?: any) {
        return UserApiFp(this.configuration).affiliate(options)(this.fetch, this.basePath);
    }
     ...
     * @memberof UserApi
     */
    public block(username: string, options?: any) {
        return UserApiFp(this.configuration).block(username, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof UserApi
     */
    public blockedList(page?: number, options?: any) {
        return UserApiFp(this.configuration).blockedList(page, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof UserApi
     */
    public info(username: string, options?: any) {
        return UserApiFp(this.configuration).info(username, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof UserApi
     */
    public touch(options?: any) {
        return UserApiFp(this.configuration).touch(options)(this.fetch, this.basePath);
    }
     ...
     * @memberof UserApi
     */
    public trust(username: string, options?: any) {
        return UserApiFp(this.configuration).trust(username, options)(this.fetch, this.basePath);
    }
    ...
    public types(options?: any) {
        return UserApiFp(this.configuration).types(options)(this.fetch, this.basePath);
    }
     ...
     * @memberof UserApi
     */
    public unblock(username: string, options?: any) {
        return UserApiFp(this.configuration).unblock(username, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof UserApi
     */
    public untrust(username: string, options?: any) {
        return UserApiFp(this.configuration).untrust(username, options)(this.fetch, this.basePath);
    }
...
export const WalletApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        conversionQuotes(convertTo: string, convertFrom: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/wallet/conversion-quotes`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
This helps to avoid accidental double conversions.
        ...
        listAddresses(cryptoCurrencyCode?: string, options: any = {}): FetchArgs {
            const localVarPath = `/wallet/list-addresses`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        newAddress(options: any = {}): FetchArgs {
            const localVarPath = `/wallet/new-address`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
export const WalletApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        balance(cryptoCurrencyCode: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20020> {
            const localVarFetchArgs = WalletApiFetchParamCreator(configuration).balance(cryptoCurrencyCode, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        conversionQuotes(convertTo: string, convertFrom: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20037> {
            const localVarFetchArgs = WalletApiFetchParamCreator(configuration).conversionQuotes(convertTo, convertFrom, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
This helps to avoid accidental double conversions.
         ...
         * @throws {RequiredError}
         */
        convert(amount: number, orderId: string, quoteId: string, convertTo: string, convertFrom: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20021> {
            const localVarFetchArgs = WalletApiFetchParamCreator(configuration).convert(amount, orderId, quoteId, convertTo, convertFrom, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        listAddresses(cryptoCurrencyCode?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20036> {
            const localVarFetchArgs = WalletApiFetchParamCreator(configuration).listAddresses(cryptoCurrencyCode, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        newAddress(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse20033> {
            const localVarFetchArgs = WalletApiFetchParamCreator(configuration).newAddress(options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const WalletApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        balance(cryptoCurrencyCode: string, options?: any) {
            return WalletApiFp(configuration).balance(cryptoCurrencyCode, options)(fetch, basePath);
        },
        /**
         * Get the current conversion quotes for supported crypto currency pairs.
         * @summary wallet/conversion-quotes
         ...
         * @throws {RequiredError}
         */
        conversionQuotes(convertTo: string, convertFrom: string, options?: any) {
            return WalletApiFp(configuration).conversionQuotes(convertTo, convertFrom, options)(fetch, basePath);
        },
        /**
         * Convert from one crypto currency to another.
         * @summary wallet/convert
...
This helps to avoid accidental double conversions.
         ...
         * @throws {RequiredError}
         */
        convert(amount: number, orderId: string, quoteId: string, convertTo: string, convertFrom: string, options?: any) {
            return WalletApiFp(configuration).convert(amount, orderId, quoteId, convertTo, convertFrom, options)(fetch, basePath);
        },
        /**
         * Fetch list of your addresses.
         * @summary wallet/list-addresses
         ...
         * @throws {RequiredError}
         */
        listAddresses(cryptoCurrencyCode?: string, options?: any) {
            return WalletApiFp(configuration).listAddresses(cryptoCurrencyCode, options)(fetch, basePath);
        },
        /**
         * Generate a new wallet address (currently only BTC is supported).
         * @summary wallet/new-address
         ...
         * @throws {RequiredError}
         */
        newAddress(options?: any) {
            return WalletApiFp(configuration).newAddress(options)(fetch, basePath);
        },
    };
};
...
export class WalletApi extends BaseAPI {
     ...
     * @memberof WalletApi
     */
    public balance(cryptoCurrencyCode: string, options?: any) {
        return WalletApiFp(this.configuration).balance(cryptoCurrencyCode, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof WalletApi
     */
    public conversionQuotes(convertTo: string, convertFrom: string, options?: any) {
        return WalletApiFp(this.configuration).conversionQuotes(convertTo, convertFrom, options)(this.fetch, this.basePath);
    }
...
This helps to avoid accidental double conversions.
     ...
     * @memberof WalletApi
     */
    public convert(amount: number, orderId: string, quoteId: string, convertTo: string, convertFrom: string, options?: any) {
        return WalletApiFp(this.configuration).convert(amount, orderId, quoteId, convertTo, convertFrom, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof WalletApi
     */
    public listAddresses(cryptoCurrencyCode?: string, options?: any) {
        return WalletApiFp(this.configuration).listAddresses(cryptoCurrencyCode, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof WalletApi
     */
    public newAddress(options?: any) {
        return WalletApiFp(this.configuration).newAddress(options)(this.fetch, this.basePath);
    }
