...
$SWAGGER_CODEGEN generate -i /gen/schema/paxful.json -l pxSdk -o /src/gen/paxful
$SWAGGER_CODEGEN generate -i /gen/schema/webhook.json -l pxSdk -o /src/gen/webhook
